 ...
 */
public class ZappleRentalApp extends Application {
	private static final String TAG = "ZappleRentalApp";
	private static final boolean DEBUG = true;

	private static boolean sIsLogined = false;
	private static ZappleRentalApp sZappleRentalApp = null;
	//百度MapAPI的管理类
...
//		}    			
    ...
    public synchronized static ZappleRentalApp getApplication() {
	...
	static class MyGeneralListener implements MKGeneralListener {
		...
		public void onGetNetworkState(int iError) {
			...
			Toast.makeText(ZappleRentalApp.sZappleRentalApp.getApplicationContext(), "您的网络出错啦！",
		...
		public void onGetPermissionState(int iError) {
			...
			if (iError ==  MKEvent.ERROR_PERMISSION_DENIED) {
				// 授权Key错误：
				Toast.makeText(ZappleRentalApp.sZappleRentalApp.getApplicationContext(), 
						"请在BMapApiDemoApp.java文件输入正确的授权Key！",
						Toast.LENGTH_LONG).show();
				ZappleRentalApp.sZappleRentalApp.m_bKeyRight = false;
			}
		}
	}    
