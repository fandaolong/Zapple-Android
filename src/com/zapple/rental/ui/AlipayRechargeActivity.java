...
/**
 * This activity providers Alipay recharge feature.
 */
public class AlipayRechargeActivity extends Activity {
	private static final String TAG = "AlipayRechargeActivity";
...
//	private TextView mTitleTextView;
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(final Message msg) {
			switch (msg.what) {
				case UPLOAD_SUCCESS:{
					Toast.makeText(AlipayRechargeActivity.this, (String) msg.obj, Toast.LENGTH_SHORT).show();					
					break;
				}
			}
		}
