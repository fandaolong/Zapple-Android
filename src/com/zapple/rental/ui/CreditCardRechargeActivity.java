...
/**
 * This activity providers credit card recharge feature.
 */
public class CreditCardRechargeActivity extends Activity {
	private static final String TAG = "CreditCardRechargeActivity";
...
//	private TextView mTitleTextView;
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(final Message msg) {
			switch (msg.what) {
				case UPLOAD_SUCCESS:{
					Toast.makeText(CreditCardRechargeActivity.this, (String) msg.obj, Toast.LENGTH_SHORT).show();					
					break;
				}
			}
		}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.alipay_recharge_layout);
