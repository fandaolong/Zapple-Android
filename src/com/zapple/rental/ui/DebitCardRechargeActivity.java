 ...
 */
public class DebitCardRechargeActivity extends Activity {
	private static final String TAG = "DebitCardRechargeActivity";
...
//	private TextView mTitleTextView;
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(final Message msg) {
			switch (msg.what) {
				case UPLOAD_SUCCESS:{
					Toast.makeText(DebitCardRechargeActivity.this, (String) msg.obj, Toast.LENGTH_SHORT).show();					
					break;
				}
			}
		}
