...
//		mListView.setEmptyView((TextView) findViewById(R.id.empty));
		...
		mVehicleListAdapter.setFromWhere(StoreDetailActivity.FROM_FAVORITE);
...
//		});				
	...
	private void doActionEnterStoreDetail(String storeId, String storeName) {
		...
		intent.putExtra(StoreDetailActivity.FROM_WHERE_EXTRA, StoreDetailActivity.FROM_FAVORITE);
		intent.putExtra(StoreDetailActivity.STORE_ID_EXTRA, storeId);
		intent.putExtra(StoreDetailActivity.STORE_NAME_EXTRA, storeName);		
		try {
