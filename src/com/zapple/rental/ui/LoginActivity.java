...
public class LoginActivity extends Activity {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(final Message msg) {
            switch (msg.what) {
                case LOGIN_SUCCESS: {
                     Toast.makeText(LoginActivity.this, R.string.login_success_label, 
                    		 Toast.LENGTH_SHORT).show();  
                     ZappleRentalApp.getApplication().setLogined(true);
                     setResult(RESULT_OK);
                     finish();
                    break;
                }
                case LOGIN_FAILURE: {
                    ...
                    Toast.makeText(LoginActivity.this, failureReason, 
                    		Toast.LENGTH_SHORT).show();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mRememberCheckBox = (CheckBox) findViewById(R.id.remember_check_box);
		mLoginButton = (Button) findViewById(R.id.login_button);
		mRegisterAccountButton = (Button) findViewById(R.id.register_account_button);
		mRetrievePasswordButton = (Button) findViewById(R.id.retrieve_password_button);
...
//    	mPasswordEditText.setText("a123456");
    ...
    private void doActionEnterRegisterAccount() {
