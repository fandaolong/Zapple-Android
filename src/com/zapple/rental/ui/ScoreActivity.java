...
/**
 * This activity providers Score feature.
 */
public class ScoreActivity extends Activity {
	...
	private ScoreListAdapter mListAdapter;
...
//                	});
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mListAdapter = new ScoreListAdapter(this, null);
	...
	private void startListQuery() {
        ...
        try {       	
            ...
            mBackgroundQueryHandler.startQuery(
                    LIST_QUERY_TOKEN, null, ScoreTable.CONTENT_URI,
                    ScoreListAdapter.SCORE_PROJECTION, selection, null, null);
