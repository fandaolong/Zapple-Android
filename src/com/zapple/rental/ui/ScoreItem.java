...
public class ScoreItem {
    ...
    public ScoreItem(Cursor cursor) {
    	if (cursor != null) {
    		mId = cursor.getLong(ScoreListAdapter.COLUMN_ID);    		
    		mRemoteId = cursor.getLong(ScoreListAdapter.COLUMN_REMOTE_ID);
    		mDescription = cursor.getString(ScoreListAdapter.COLUMN_DESCRIPTION);
    		mScoreValue = cursor.getString(ScoreListAdapter.COLUMN_SCORE_VALUE);
    		mDate = cursor.getString(ScoreListAdapter.COLUMN_DATE);
    		mExpiryDate = cursor.getString(ScoreListAdapter.COLUMN_EXPIRY_DATE);  		
    	}
    }
