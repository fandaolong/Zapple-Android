...
/**
 * The back-end data adapter for StoreList.
 */
public class StoreListAdapter extends CursorAdapter implements AbsListView.RecyclerListener {
    ...
    public interface OnContentChangedListener {
        void onContentChanged(StoreListAdapter adapter);
    }
