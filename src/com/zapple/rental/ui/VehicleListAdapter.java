...
/**
 * The back-end data adapter for VehicleList.
 */
public class VehicleListAdapter extends CursorAdapter implements AbsListView.RecyclerListener {
    ...
    public VehicleListAdapter(Context context, Cursor cursor) {
    ...
    public interface OnContentChangedListener {
        void onContentChanged(VehicleListAdapter adapter);
    }
